...
def generate_fer2013(dir_path, num_clients, num_classes, niid, balance, partition, alpha, few_shot, n_shot, pfl):
    ...
    trainset = torchvision.datasets.FER2013(
        root=dir_path+"rawdata", split='train', transform=transform)
    # testset = torchvision.datasets.FER2013(
    #     root=dir_path+"rawdata", split='test', transform=transform)
...
if __name__ == "__main__":
    ...
    generate_fer2013(dir_path, num_clients, num_classes, niid, balance, partition, alpha, few_shot, n_shot, pfl)