...
def generate_caltech101(dir_path, num_clients, num_classes, niid, balance, partition, alpha, few_shot, n_shot):
...
if __name__ == "__main__":
    ...
    generate_caltech101(dir_path, num_clients, num_classes, niid, balance, partition, alpha, few_shot, n_shot)