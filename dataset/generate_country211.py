...
def generate_country211(dir_path, num_clients, num_classes, niid, balance, partition, alpha, few_shot, n_shot, pfl):
    ...
    valset = torchvision.datasets.Country211(
        root=dir_path+"rawdata", split='valid', download=True, transform=transform)
...
if __name__ == "__main__":
    ...
    generate_country211(dir_path, num_clients, num_classes, niid, balance, partition, alpha, few_shot, n_shot, pfl)